...
from hierasafe_flow.adapters.unsupported_adapter import Cosmos3TextToImageAdapter, JoyAIEchoAdapter
...
def get_adapter_class(adapter_name: str | None = None, model_id: str | None = None) -> Type[FrozenGeneratorAdapter]:
    key = adapter_name
