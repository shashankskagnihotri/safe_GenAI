...
class Ideogram4Adapter(FrozenGeneratorAdapter):
    ...
    def begin_conditioning_provenance_scope(self) -> None:
        # The caption and its provenance must have the same sample lifetime.
        # Retaining captions while clearing records would make duplicate prompts
        # hit the cache without recreating the record required by
        # _validate_post_encode_indicator.
        self._native_caption_cache.clear()
        self._conditioning_records.clear()
