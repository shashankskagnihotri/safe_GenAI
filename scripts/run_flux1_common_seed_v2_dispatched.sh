...
MANIFEST="${1:?Usage: run_flux1_common_seed_v2_dispatched.sh MANIFEST INDEX PHASE_PLAN}"
INDEX="${2:?Usage: run_flux1_common_seed_v2_dispatched.sh MANIFEST INDEX PHASE_PLAN}"
PHASE_PLAN="${3:?Usage: run_flux1_common_seed_v2_dispatched.sh MANIFEST INDEX PHASE_PLAN}"
if [ "$#" -ne 3 ]; then
